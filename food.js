    ...
    draw(){
        if(this.game.debug){
            ...
            this.game.ctx.fillRect(this.x * this.game.cellSize,
                this.y * this.game.cellSize,  this.game.cellSize,  this.game.cellSize
            )
        }
        ...
        this.game.ctx.drawImage(this.image, 
            ...
            this.x * this.game.cellSize, (this.y - 1) * this.game.cellSize, this.game.cellSize, this.game.cellSize * 2)
    }
    update(){
