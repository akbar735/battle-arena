...
class Game {
    ...
    initPlayer1(){
        ...
        if(this.gameUi.player1Controls.value === 'arrows'){
            this.player1 = new Keyboard1(this, 0, this.topMargin, 0, 1, 'magenta', name, image);
        }else{
            this.player1 = new ComputerAi(this, 0, this.topMargin, 0, 1, 'magenta', name, image);
        }
    }
    initPlayer2(){
        ...
        if(this.gameUi.player1Controls.value === 'wsad'){
            this.player2 = new Keyboard2(this, 0, this.rows - 1, 0, 0, 'yellow', name, image)
        }else{
            this.player2 = new ComputerAi(this, 0, this.rows - 1, 1, 0, 'yellow', name, image)
        }
    }
    ...
    initPlayer3(){
        ...
        this.player3 = new ComputerAi(this, this.columns -1, this.topMargin, 0, 0, 'red', name, image);
    }
    initPlayer4(){
        const image = document.getElementById(this.gameUi.player4character.value);
        const name = this.gameUi.player4name.value;
        this.player4 = new ComputerAi(this, this.columns -1, this.rows - 5, 0, 1, 'blue', name, image)
    }
